...
public:
	...
	//计算距离场
	bool ComputDistanceField(vector<Particle> &particles, HashGrid &hashGrid, double radius = 2);
	//获取坐标距离值
	double GetDisValue(double x, double y, double z, const vector<Particle> &particles, HashGrid &hashGrid, double radius = 2);
};
